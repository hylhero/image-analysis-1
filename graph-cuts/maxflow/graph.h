/* graph.h */
/*
	NOTE: THE FILE BELOW WAS MODIFIED TO INCLUDE A DECLARATION OF A FRIEND CLASS "Graph2D"
...
{
	friend class Graph2D; // declaration added by Y.B. for visualization purposes 
